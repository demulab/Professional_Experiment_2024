...
def main(args=None):
    ...
    while rclpy.ok():  
        ...
        open_manipulator_x.move([open_manipulator_x.marker_pose.position.x, open_manipulator_x.marker_pose.position.y, open_manipulator_x.marker_pose.position.z + 0.08, 90.0], vel, accel)
        open_manipulator_x.move([open_manipulator_x.marker_pose.position.x, open_manipulator_x.marker_pose.position.y, open_manipulator_x.marker_pose.position.z + 0.06, 90.0], vel, accel)
