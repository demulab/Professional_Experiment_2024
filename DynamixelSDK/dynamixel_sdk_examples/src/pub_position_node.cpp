...
void JointPubNode::publishData()
{
  ...
  msg.position = positions_1_[current_position_index_];
  msg.velocity = velocity_1_[current_position_index_];
  msg.acceleration = acceleration_1_[current_position_index_];
  msg.id = 11;    
  RCLCPP_INFO(get_logger(), "\nPublishing ID: %d Position: %d, Velocity: %d, Acceleration: %d", msg.id, msg.position, msg.velocity, msg.acceleration);
